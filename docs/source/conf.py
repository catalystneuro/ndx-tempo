...
# -*- coding: utf-8 -*-
#
# ndx-tempo documentation build configuration file, created by
# sphinx-quickstart on Sat Dec 28 14:04:10 2019.
#
...
htmlhelp_basename = 'ndx-tempodoc'
...
latex_documents = [
    (master_doc, 'ndx-tempo.tex', 'ndx-tempo Documentation',
     'Saksham Sharda', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-tempo', 'ndx-tempo Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-tempo', 'ndx-tempo Documentation',
     author, 'ndx-tempo', 'One line description of project.',
     'Miscellaneous'),
]
