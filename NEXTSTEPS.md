# Next Steps for ndx-tempo Extension for NWB:N

## Creating Your Extension

1. In a terminal, change directory into the new ndx-tempo directory.
...
4. Modify `src/create_extension_spec.py` to define your extension.
    ...
    - If you want to create any custom classes for interacting with the extension,
      ...
      - If present, the `src/pynwb` folder MUST contain the following:
        - `ndx-tempo` - Folder with the sources of the NWB extension
        - `ndx-tempo/__init__.py` - Python file that may be empty
...
`spec/ndx-tempo.namespace.yaml` and
`spec/ndx-tempo.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-tempo
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/Saksham20/ndx-tempo/releases/tag/0.1.0

9. Publish your updated extension on PyPi.
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-tempo/0.1.0
...
`staged-extensions/ndx-tempo`:

    ```bash
cp -r staged-extensions/example staged-extensions/ndx-tempo
```

11. Edit `staged-extensions/ndx-tempo/ndx-meta.yaml`
...
name: ndx-tempo
version: 0.1.0
src: https://github.com/Saksham20/ndx-tempo
pip: https://pypi.org/project/ndx-tempo/
license: BSD 3-Clause
maintainers:
  - Saksham20
```

12. Edit `staged-extensions/ndx-tempo/README.md`
to add information about your extension. You may copy it from
`ndx-tempo/README.md`.

  ```bash
cp ndx-tempo/README.md staged-extensions/ndx-tempo/README.md
```
...
ndx-tempo-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-tempo GitHub repository.

2. Publish your updated extension on PyPi.

3. Fork the ndx-tempo-feedstock repository on GitHub.
